<template>
  <div class="fixed w-full flex justify-between bg-gray-100" style="bottom: 0">
    <textarea
      class="flex-grow m-2 py-2 px-4 mr-1 rounded-full border border-gray-300 resize-none"
      rows="1"
      placeholder="Message..."
      v-model="message"
      style="outline: none"
